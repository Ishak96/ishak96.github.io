...
// Apply the dark theme to the website.
let applyTheme = () => {
...
let setHighlight = (theme) => {
  const darkThemeStylesheet = document.getElementById("highlight_theme_dark");
  if (darkThemeStylesheet) {
    darkThemeStylesheet.media = "";
  }
};
...
// Determine the computed theme. In this project it is always dark.
